...
<head>
    ...
    <link hreft="animation.css" rel="stylesheet"
        ...
        <div class="container">
            <div class="intro-message">  
                ...
                <h1 style="color: #2B2B2B;
                 font-family: Lucida Grande, Lucida Sans Unicode, Lucida Sans, DejaVu Sans, Verdana,' sans-serif'; border-bottom-left-radius: 5px;
                 border-bottom-right-radius: 5px;">
                    Market your Catering Services FOR FREE!
                </h1>
        ...
        <div class="container">
            ...
            <div class="row" style="margin-top: 3em; margin-bottom: 3em">
                ...
                <div class="col-lg-5 col-lg-offset-1 col-sm-push-6  col-sm-6">
                    ...
                    <h2 class="section-heading">VERY USEFUL IN YOUR CATERING SERVICES</h2>
                    <p class="lead">You have nothing to worry this is free of charge and this is for all who just start up catering services and don't have yet Website or even your services has, You will try it and Market your Catering services here.</p>
                </div>
                <div class="col-lg-5 col-sm-pull-6  col-sm-6">
                    <img class="img-responsive" src="images/free.jpg" alt="">
                </div>
            </div>
...
<div class="container">
    <div class="row">
            ...
            <div class="col-lg-12">
                <img class="img-responsive" src="images/3steps.png" alt="">
            </div>
...
<div class="row" style="margin-top: 1em; margin-bottom: 3em">
    ...
    <div class="col-lg-12  col-sm-12">
        ...
        <div class="clearfix"></div>
        <h2 class="section-heading" style="text-align: center; font-size: 2.5em">It's time to build your business to a bigger and wider platform.</h2>
        
        <center>
        <a  href="first_step.php" class="btn btn-warning btn-lg"><span class="network-name">CREATE ACCOUNT SERVICES NOW</span></a>
        </center>
    </div>
    <!-- <div class="col-lg-5 col-sm-pull-6  col-sm-6">
        <img class="img-responsive" src="images/free.jpg" alt="">
                    ...
                    <div class="modal-header">
                        ...
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                                            ...
                                            <div class="col-lg-offset-1 col-md-10">
                                                ...
                                                <h5 style="text-align:center">Create you Account</h5>
                                            </div>
                    </div>
