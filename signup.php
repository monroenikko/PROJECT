    ...
    <div class="signin-form">
        ...
        <div class="container">
            ...
            <form class="form-signin" method="post" id="register-form">
                ...
                <h4 class="form-signin-heading" style="text-align:center">Create your Account:</h4>
                <hr />
                ...
                <div class="form-group">
                    ...
                    <button type="submit " class="btn btn-primary btn-lg btn-block" name="btn-save " id="btn-submit ">
