...
$stmt = $pdo->query('SELECT * FROM log limit 5');
?>
        ...
        <div class="container topnav">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right list-inline">
                    ...
                    <li class="active">
                    <a class="btn btn-link btn-lg" href="#">Sign Up</a>
                    </li>
                    <li class="dropdown">
                ...
                <div class="col-lg-5 col-sm-6">
                    ...
                    <div class="clearfix"></div>
                        ...
                        <div class="col-lg-12">
                            ...
                            <li>
                                <a href="https://twitter.com/SBootstrap" class="btn btn-primary btn-lg"> <span class="network-name"><i>Read More</i></span></a>
                            </li>
                            </ul>
                        </div>
